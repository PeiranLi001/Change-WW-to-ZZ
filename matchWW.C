...
void matchWW(){
  ...
  for (int i=0; i<entries1; ++i){
    ...
    Phi_q[0]=(gen_leading_WpJets_Phi);
    Phi_q[1]=(gen_Subleading_WpJets_Phi);
    Phi_q[2]=(gen_leading_WmJets_Phi);
    Phi_q[3]=(gen_Subleading_WmJets_Phi);
    ...
    testdR->Fill(deltaR(AK8Gen_HiggsJet_minDMass_Eta,AK8Gen_HiggsJet_minDMass_Phi, Eta_q[0], Phi_q[0]));
