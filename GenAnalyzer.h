...
void GenAnalyzer::SetBranches(){
  ...
  AddBranch(&gen_HiggsZZ_Pt_, "gen_HiggsZZ_Pt");
  AddBranch(&gen_HiggsZZ_Eta_, "gen_HiggsZZ_Eta");
  AddBranch(&gen_HiggsZZ_Phi_, "gen_HiggsZZ_Phi");
  AddBranch(&gen_HiggsZZ_M_, "gen_HiggsZZ_M");
