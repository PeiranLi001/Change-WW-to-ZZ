...
private:
  ...
  double AK4GEN_AllResolved_offShellZbosonZ_dR_Z1PID_  = -999.0;
...
void GenAnalyzer::SetBranches(){
  ...
  AddBranch(&gen_leading_ZZBoson_Pt_, "gen_leading_ZZBoson_Pt");
  AddBranch(&gen_leading_ZZBoson_Eta_, "gen_leading_ZZBoson_Eta");
  AddBranch(&gen_leading_ZZBoson_Phi_, "gen_leading_ZZBoson_Phi");
  AddBranch(&gen_leading_ZZBoson_M_, "gen_leading_ZZBoson_M");
...
void GenAnalyzer::Clear(){
  ...
  AK8Gen_MergedZjets_minWminHmass_Leading_Pt_ = -999.0;
  AK8Gen_MergedZjets_minWminHmass_Leading_Eta_ = -999.0;
  AK8Gen_MergedZjets_minWminHmass_Leading_Phi_ = -999.0;
  AK8Gen_MergedZjets_minWminHmass_Leading_M_ = -999.0;
  AK8Gen_MergedZjets_minWminHmass_Leading_deltaR_H1_ = -999.0;
  AK8Gen_MergedZjets_minWminHmass_Leading_deltaR_H2_ = -999.0;
  AK8Gen_MergedZjets_minWminHmass_SubLeading_Pt_ = -999.0;
  AK8Gen_MergedZjets_minWminHmass_SubLeading_Eta_ = -999.0;
  AK8Gen_MergedZjets_minWminHmass_SubLeading_Phi_ = -999.0;
  AK8Gen_MergedZjets_minWminHmass_SubLeading_M_ = -999.0;
  AK8Gen_MergedZjets_minWminHmass_SubLeading_deltaR_H1_ = -999.0;
  AK8Gen_MergedZjets_minWminHmass_SubLeading_deltaR_H2_ = -999.0;
  AK8Gen_MergedZjets_minWminHmass_LeadingSubLeading_DR_   = -999.0;

  AK8Gen_MergedZjets_minWminHmass_Higgs_Pt_ = -999.0;
  AK8Gen_MergedZjets_minWminHmass_Higgs_Eta_  = -999.0;
  AK8Gen_MergedZjets_minWminHmass_Higgs_Phi_  = -999.0;
  AK8Gen_MergedZjets_minWminHmass_Higgs_M_  = -999.0;
  AK8Gen_MergedZjets_minWminHmass_Higgs_deltaR_H1_  = -999.0;
  AK8Gen_MergedZjets_minWminHmass_Higgs_deltaR_H2_  = -999.0;
